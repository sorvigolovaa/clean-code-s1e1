...
var taskInput=document.getElementById("main__task");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("main__section-todo");//ul of #incompleteTasks
